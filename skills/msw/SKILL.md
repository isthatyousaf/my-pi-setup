---
name: msw
description: "MSW - Minimum Sufficient Work kernel. Scope, execute, verify, and halt any task by necessity: implementation, debugging, review, research, planning. Use when scope control matters, when over-engineering threatens, or on the words MSW, minimum sufficient work, only what is necessary."
---
